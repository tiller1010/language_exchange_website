  ...
  return (
    <html style={{ fontFamily: 'sans-serif' }} translate="yes" lang="en">
      <head>
        ...
        content={ props.description || 'Language can only be learned if it is used. Why not start using the language you want to learn today? Complete free lessons and challenges to sharpen your skills. Practice your new skills with language learners around the world. Schedule a time to get real practice with a native speaker.' }></meta>
