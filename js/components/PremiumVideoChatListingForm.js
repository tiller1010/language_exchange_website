...
// @ts-ignore
var PremiumVideoChatListing_tsx_1 = require("./PremiumVideoChatListing.tsx");
// @ts-ignore
var RemoveConfirmationModal_tsx_1 = require("./RemoveConfirmationModal.tsx");
// @ts-ignore
var LanguageSelector_tsx_1 = require("./LanguageSelector.tsx");
...
var PremiumVideoChatListingForm = /** @class */ (function (_super) {
    ...
    PremiumVideoChatListingForm.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "pure-g" },
            React.createElement("h2", { className: "pure-u-1" }, "Premium video chat listing"),
            React.createElement("form", { className: "pure-u-1 fw-form" },
                React.createElement("div", { className: "flex-container desktop-100" },
                    React.createElement("div", { className: "desktop-50 phone-100" },
                        ...
                        React.createElement(LanguageSelector_tsx_1.default, { name: "languageOfTopic", id: "languageOfTopicField", onChange: function (event) { return _this.setState({ languageOfTopic: event.target.value, savedAllChanges: false }); }, value: languageOfTopic }),
                        React.createElement("div", { className: "field text" },
            ...
            React.createElement("div", { className: "pure-u-1 flex-container flex-horizontal-center" }, savedPremiumVideoChatListing ?
                React.createElement("div", null,
                    ...
                    React.createElement(PremiumVideoChatListing_tsx_1.default, { premiumVideoChatListing: savedPremiumVideoChatListing, authenticatedUserID: user._id, view: user._id == savedPremiumVideoChatListing.userID ? 'owner' : 'customer' }),
                    React.createElement("form", null,
                        React.createElement("a", { className: "button", href: "#remove-listing", style: { width: 'max-content' } },
                            "Remove Listing",
                            React.createElement(react_fontawesome_1.FontAwesomeIcon, { icon: free_solid_svg_icons_1.faTrash }))),
                    React.createElement(RemoveConfirmationModal_tsx_1.default, { buttonText: "Remove Listing", buttonAnchor: "remove-listing", modalTitle: "Remove Listing", modalContent: "Are you sure you want to remove this listing?", handleDelete: this.handleDeleteListing }))
                :
                    '')));
    };
