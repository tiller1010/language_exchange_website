...
export default class VideoChat extends React.Component<VideoChatProps, VideoChatState> {
  ...
  async createCall(){
    ...
    // @ts-ignore
    window.socket.emit('Call Sent', forUserID,
      `<p><b>Your video call has started. <a href="/video-chat?withUserID=${authenticatedUserID}">Use this link to go to your video call.</a></p>\
      <br>\
      <p><b>Or go to your account profile and click the video chat link under your purchase.</b>`
    );
