...
// @ts-ignore
var MediaRenderer_tsx_1 = require("./MediaRenderer.tsx");
        ...
        return (React.createElement("div", null,
            React.createElement("div", { className: "flex x-center" },
                React.createElement("div", { style: { maxWidth: '100%' } },
                    React.createElement("div", { className: "flex x-space-between y-center" },
                        ...
                        this.props.handleDeleteVideo ?
                            React.createElement("form", { action: "/videos/remove", method: "POST", className: "fw-form" },
                                ...
                                React.createElement("a", { className: "button", href: "#remove-video", onClick: function (event) { return _this.props.handleDeleteVideo(event); } },
                                    "Remove Video",
                    ...
                    React.createElement(MediaRenderer_tsx_1.default, { src: src, thumbnailSrc: thumbnailSrc }))),
