...
var VideoChat = /** @class */ (function (_super) {
    ...
    VideoChat.prototype.componentDidMount = function () {
        return __awaiter(this, void 0, void 0, function () {
            var firebaseConfig, firebaseApp, firestore, servers, peerConnection, urlParams, forUserID, withUserID, forUserDisplayName, withUserDisplayName_1, callsCollection_1, filteredCallsCollection, callDocs, callDocsArray_1, availableCalls_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        filteredCallsCollection = (0, firestore_1.query)(callsCollection_1, (0, firestore_1.where)('offer.forUserID', '==', this.props.authenticatedUserID));
    ...
    VideoChat.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "frame" },
            ...
            React.createElement("div", { className: "pure-u-g" },
                React.createElement("h2", null, "Start your Webcam"),
                React.createElement("div", { className: "flex x-center" },
                    React.createElement("div", { className: "pure-u-1 pure-u-md-1-2" },
                        React.createElement("div", { className: "pad" },
                            React.createElement("h3", null, "Local Stream"),
                            React.createElement("video", { id: "webcamVideo", autoPlay: true, playsInline: true, muted: true, ref: this.webcamVideo }))),
                    React.createElement("div", { className: "pure-u-1 pure-u-md-1-2" },
                        React.createElement("div", { className: "pad" },
                            React.createElement("h3", null, "Remote Stream"),
                            React.createElement("video", { id: "remoteVideo", autoPlay: true, playsInline: true, ref: this.remoteVideo })))),
                this.state.webcamButtonDisabled ?
                    React.createElement("div", { className: "flex x-center y-center" }, this.renderCallControls())
                    :
